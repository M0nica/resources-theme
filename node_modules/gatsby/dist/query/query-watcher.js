...
const handleQuery = ({
  ...
  if (query.isStaticQuery) {
    ...
    if (isNewQuery || oldQuery.hash !== query.hash || oldQuery.query !== query.text) {
...
const watch = async rootDir => {
  ...
  watcher = chokidar.watch([slash(path.join(rootDir, `/src/**/*.{js,jsx,ts,tsx}`)), ...packagePaths]).on(`change`, path => {
